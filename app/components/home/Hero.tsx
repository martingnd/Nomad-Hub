...
export default function Hero() {
  return (
    <div className="relative h-[640px] w-full overflow-hidden">
      ...
      <div className="relative mx-auto flex h-full max-w-site flex-col justify-end px-6 pb-16 md:px-12">
        ...
        <h1 className="mb-[22px] max-w-[720px] text-[40px] font-bold leading-[1.08] text-cream [text-wrap:balance] md:text-[58px]">
          Travaillez ailleurs, sans compromis.
        </h1>
        <p className="mb-3.5 max-w-[500px] text-lg leading-relaxed text-cream/90 [text-wrap:pretty]">
        ...
        <p className="mb-8 max-w-[480px] text-[13.5px] italic leading-snug text-cream/65">
