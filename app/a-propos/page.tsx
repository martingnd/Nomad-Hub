...
const VALUES = [
  { Icon: ProfileIcon, title: "Communauté", body: "Un réseau de professionnels du remote qui s'entraident, échangent et avancent ensemble." },
  { Icon: StarIcon, title: "Qualité", body: "Des hébergements sélectionnés et vérifiés, à la hauteur de l'exigence d'un vrai cadre de travail." },
  { Icon: HeartIcon, title: "Sérénité", body: "Tout est organisé pour que vous n'ayez qu'à vous concentrer sur ce qui compte vraiment." },
  { Icon: GrowthIcon, title: "Productivité", body: "Un cadre pensé pour travailler mieux, pas juste ailleurs." },
];
        ...
        <div className="mx-auto max-w-site px-6 md:px-12">
          ...
          <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {VALUES.map(({ Icon, title, body }) => (
              <div key={title} className="flex flex-col gap-3 rounded-[22px] bg-white/70 p-6">
